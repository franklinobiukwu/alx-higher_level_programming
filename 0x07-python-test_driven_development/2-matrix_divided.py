#!/usr/bin/python3
"""Module of matrix_divided - A function that devides all elements of a matric"""
...
def matrix_divided(matrix, div):
	...
	if (not isinstance(matrix, list)
		...
		or not all([(isinstance(elem, int) or isinstance(elem, float)) for row in matrix for elem in row])):
